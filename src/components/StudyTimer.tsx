...
export const StudyTimer = ({ onSessionComplete }: StudyTimerProps) => {
  ...
  const stopTimer = () => {
    ...
    if (time > 0) {
      ...
      // 100 XP + 10 coins for every 5 minutes (300 seconds)
      const fiveMinuteBlocks = Math.floor(time / 300);
      const baseXP = fiveMinuteBlocks * 100;
      const baseCoins = fiveMinuteBlocks * 10;
      ...
      <div className="relative z-20">
        ...
        <div className="flex justify-center gap-4">
          ...
          <Button 
            ...
            size="lg"
            variant="outline"
            className="border-white/20 text-white hover:bg-primary/20 transition-bounce"
          >
